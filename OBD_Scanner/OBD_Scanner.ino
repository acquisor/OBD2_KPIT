...
void loop()
{
  ...
  if (WiFi.status() == WL_CONNECTED && dataReceivedCount == 5)
  {
    dataReceivedCount = 0;
    Serial.print("\nThis device's IP: ");
    ...
    acqWifi.generateURL(customerName, speedData, rpmData, loadData, throttleData, dtcData);
    speedData = "", rpmData = "", loadData = "", throttleData = "", dtcData = "";
